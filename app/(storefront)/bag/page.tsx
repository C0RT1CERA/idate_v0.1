...
import { DeleteItem } from "@/components/SubmitButton";
            ...
            {cart?.items.length === 0 ? (
                <div className="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center mt-20">
                    ...
                    <h2 className="mt-6 text-xl font-semibold">
                        You dont have any product in the Bag!
                    </h2>
                    <p className="mb-8 mt-2 text-center text-sm text-muted-foreground max-w-sm mx-auto">
                        You currently dont have any product in your shopping bag. Please add some so that you can see the right here.
                    </p>
